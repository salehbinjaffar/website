...
function saveHeaderBannerImageFromBase64(dataUrl) {
  const name = "hb_" + Date.now() + "_" + crypto.randomBytes(4).toString("hex");
  return saveBase64Image(dataUrl, "header-banner/" + name);
}
...
module.exports = {
  ...
  saveHeaderBannerImageFromBase64,
  applyUploadToBody,
  applyLogoToSettings,
  UPLOAD_DIR,
};
